...
- Phase B semantic-guardrail design and its B5 decision are operator-approved.
  C1, C7, C2, C4, C5, and the offline parser-runtime packaging are green at T1.
  C8/C9 and the approved C6 contract may now use the local runtime. C3 remains
  separately bounded by A3/A4/A5. Any canary still needs named data, numeric
  limits, and separate approval.
