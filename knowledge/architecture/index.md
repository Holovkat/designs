...
| [Post-Commit Hook System](./hook-system.md) | Lightweight commit metadata capture to knowledge/inbox/ via git post-commit hook | [okf, git, hooks, post-commit, inbox, capture] | active |
| [OKF Installer Design](./installer-design.md) | How install-okf.sh deploys knowledge directory, viewer, hook, and AGENTS.md section | [okf, installer, bash, deployment, setup] | active |
