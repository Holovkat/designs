...
- Phase B semantic-guardrail design and its B5 decision are operator-approved.
  C1, C7, C2, C4, and C5 are green at T1. The operator deferred C8/C9 because
  installed parser-runtime distribution is not approved. C3 shares that
  dependency and remains deferred; C6 lacks a separately approved contract.
