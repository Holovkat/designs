...
single-session limits from its approved plan. The defaults install no
scheduled-curation profile/prompt/adapter, cron, launchd, Factory task, queue,
polling process, retry loop, or network client.
