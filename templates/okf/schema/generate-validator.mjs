...
const schemaPath = resolve(directory, "okf-core-1.0.schema.json");
const outputPath = resolve(directory, "okf-core-1.0.validator.mjs");
...
const banner = "// Generated from okf-core-1.0.schema.json by generate-validator.mjs.\n// Runtime dependency-free; regenerate only through the reviewed schema workflow.\n";
...
writeFileSync(outputPath, `${banner}${standalone}`, "utf8");
