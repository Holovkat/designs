...
| [OKF Offline Installer Design](./installer-design.md) | File-copy installer for the bundle, bounded tools including an inert scheduler adapter, controls, hooks, viewer, and contracts | [bash, deployment, installer, offline, okf, setup] | active |
| [Bounded Scheduled Curation Adapter](./bounded-scheduled-curation-adapter.md) | One-item one-session adapter with pinned authority, no-retry evidence, exact commits, and fail-closed stopping | [curation, fail-closed, okf, scheduler, safety] | active |
