...
- Phase B semantic-guardrail design and its B5 decision are operator-approved.
  C1, C7, C2, C4, and C5 are green at T1. The operator approved local runtime
  packaging to unblock C8/C9 design and implementation; C3 remains separately
  bounded by A3/A4/A5, and C6 lacks a separately approved contract. Any canary
  still needs named data, numeric limits, and separate approval.
